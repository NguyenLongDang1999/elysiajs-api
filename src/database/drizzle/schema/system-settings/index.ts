...
// ** Schema
export const systemSettingsSchema = pgTable('system-settings', {
...
export const systemSettingOptionsSchema = pgTable('system-setting-options', {
    id: text('id').primaryKey().$defaultFn(createId),
    system_setting_id: text('system_setting_id')
        .notNull()
        .references(() => systemSettingsSchema.id),
