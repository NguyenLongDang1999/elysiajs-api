...
export const productCategoryNestedList = new Elysia()
    ...
    .use(redisPlugin)
    .use(authUserPlugin)
    .get('/data-list-nested', async ({ UserProductCategoryClass, redis }) =>
        UserProductCategoryClass.getNestedList(redis)
    )
...
export const productCategoryDataListShop = new Elysia()
    ...
    .get(
        '/data-list-shop',
        async ({ UserProductCategoryClass, query, redis, user }) => {
            try {
...
export const productCategoryRetrieve = new Elysia()
    ...
    .get(
        '/:slug',
        async ({ UserProductCategoryClass, params, query, redis, user }) => {
            try {
